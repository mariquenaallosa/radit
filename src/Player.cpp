...
{
   // w_Stream->Load("C:/discoteca/NOVEDADES DEL MES/KIKE GABANA - D�melo Bajito.mp3");


       //Start("C:/discoteca/NOVEDADES DEL MES/KIKE GABANA - D�melo Bajito.mp3",false);
   // return;
